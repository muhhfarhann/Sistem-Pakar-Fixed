...
$kodeGejala = htmlspecialchars($_GET["kodeGejala"]);

$sql = "SELECT * FROM gejala WHERE kodeGejala='$kodeGejala'";
        ...
        <div class="container border border-dark shadow-lg w-50">
            <div class="row">
                <form action="" method="post" class="row" data-sb-form-api-token="your-token-here">
                    <input type="hidden" name="kodeGejala" value="<?= $result["kodeGejala"]; ?>">
                    <div class="col-md">
                        <label for="nama" class="form-label">Nama Gejala</label>
                        <textarea name="namaGejala" id="nama" cols="50" autocomplete="off" required><?= $result["namaGejala"]; ?></textarea>
