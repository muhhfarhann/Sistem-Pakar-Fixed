...
$sql= "SELECT * FROM dataKonsultasi";
...
<body>
    ...
    $is_home_page = ($current_page == 'dataUser.php');
    ?>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="navbar-nav">
                ...
                <a href="#table" class="nav-link <?php if ($is_home_page) echo 'disabled'; ?>">User</a>
                    ...
                    <?php foreach( $result as $data ) : ?>
                        <tbody>
                            <tr>
                                ...
                                <td><?= $data["gejala"]; ?></td>
                                <td class="btn"> 
                                    <a href="updateUser.php?idKonsultasi=<?= $data["idKonsultasi"]; ?>">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="function.php?action=deleteUser&idKonsultasi=<?= $data["idKonsultasi"]; ?>" onclick="return confirm('Yakin Ingin Menghapus?');">
